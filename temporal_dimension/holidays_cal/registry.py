...
class IsoRegistry(object):
    ...
    def __init__(self, load_standard_modules=True):
        ...
        if load_standard_modules:
            for module_name in self.STANDARD_MODULES:
                module = 'temporal_dimension.holidays_calendar.{}'.format(module_name)
    ...
    def get_subregions(self, iso_code):
        ...
        {'DE-HH': <class 'temporal_dimension.holidays_calendar.europe.germany.Hamburg'>,
        'DE-BE': <class 'temporal_dimension.holidays_calendar.europe.germany.Berlin'>}
        :rtype dict
